...
%% Assemble Module 
[KPP,KPF,KFF,KFP,PP,PF,UP] = Assemble(COORDS,N_ELEM,N_LOAD,N_PRE_DISP,ELEM_NODE,ELEM_STIFF,ELEM_AREA,ELEM_LOAD,FORCE_NODE,FORCE_VAL,DISP_NODE,DISP_VAL,EQ_NUM,N_DOF);

%% Solve Module
[UUR,PUR,UF,PP]= Solve(N_NODE,KPP,KPF,KFF,KFP,PP,PF,UP,EQ_NUM);

%% Get Streain and Stress
[strain,stress] = Calc(UUR,ELEM_STIFF,COORDS,N_ELEM,ELEM_LOAD,ELEM_NODE);
%% Print Output File 
PrintOutput(EQ_NUM,KPP,KPF,KFP,KFF,UF,PP,UUR,PUR,stress,strain);
